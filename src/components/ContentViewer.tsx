  ...
  const renderContent = () => {
    switch (item.type) {
          ...
          <div className="space-y-6">
            <div className="aspect-video bg-black rounded-xl overflow-hidden shadow-lg">
              ...
              >
                <p className="text-white p-4">
                  ...
                  <a href={item.url} className="text-blue-400 underline ml-1">
                    Download the video
                  </a>
                </p>
              </video>
            ...
            <div className="prose max-w-none">
              ...
              <div className="mt-6 p-6 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-3">About this video</h3>
      ...
      case 'audio':
        return (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-pastel-pink to-pastel-purple rounded-xl p-8">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Now Playing</h3>
              ...
              >
                <p className="text-gray-600">
                  ...
                  <a href={item.url} className="text-blue-500 underline ml-1">
                    Download the audio
                  </a>
                </p>
              </audio>
            ...
            <div className="prose max-w-none">
              ...
              <div className="mt-6 p-6 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-3">Episode Notes</h3>
      ...
      case 'document':
        return (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-pastel-blue to-pastel-cyan rounded-xl p-8 text-center">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Document Viewer</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a
                  href={item.url}
                  download
                  className="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-colors font-medium"
                >
            ...
            <div className="prose max-w-none">
              <div className="p-6 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-3">Document Overview</h3>
        ...
        return (
          <div className="space-y-6">
            <article className="prose prose-lg max-w-none">
              <div className="lead text-xl text-gray-700 leading-relaxed mb-8">
                {item.description}
              </div>
              ...
              <div className="text-center mb-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
              ...
              <div className="space-y-6 text-gray-800 leading-relaxed">
                ...
                <blockquote className="border-l-4 border-soft-purple pl-6 py-2 my-6 bg-pastel-purple/30 rounded-r-lg">
                  ...
                  <footer className="text-sm text-gray-600 mt-2">— {item.author}</footer>
                </blockquote>
                ...
                <div className="bg-pastel-blue/30 rounded-lg p-6 my-6">
                ...
                <div className="text-center mt-8 p-6 bg-gradient-to-r from-pastel-yellow to-pastel-orange rounded-xl">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-3">
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                  item.type === 'video' ? 'bg-pastel-purple text-gray-700' :
                  item.type === 'audio' ? 'bg-pastel-pink text-gray-700' :
                  item.type === 'pdf' || item.type === 'document' ? 'bg-pastel-blue text-gray-700' :
                  'bg-pastel-yellow text-gray-700'
                }`}>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-3 leading-tight">{item.title}</h1>
        ...
        <div className="border-t border-gray-100 p-6 bg-gray-50/50 rounded-b-2xl">
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            {item.tags.map((tag) => (
              <span
                key={tag}
                className="bg-white border border-gray-200 text-gray-600 text-sm px-3 py-1 rounded-full hover:bg-gray-50 transition-colors cursor-pointer"
              >
                #{tag.toLowerCase()}
              </span>
            ))}
          ...
          <div className="text-xs text-gray-500 text-center">
            Published on Redwrite • {new Date(item.publishedAt).getFullYear()}
          </div>
        </div>
      </div>
    </div>
